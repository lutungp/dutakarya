...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "<?php echo BASE_URL ?>/controllers/C_penagihan.php?action=getpenagihan";
        // prepare the data
        var source =
        {
            datatype: "json",
            datafields: [
                ...
                { name: 'penagihan_aktif', type: 'string' },
            ],
            id: 'penagihan_id',
            url: url
        };
        ...
        $("#grid").jqxGrid({
            ...
            columns: [
                { text: 'No. Transaksi', datafield: 'penagihan_no', width : 200, cellsalign: 'center'},
                { text: 'Rekanan', datafield: 'rekanan_nama'},
                { text: 'Tanggal', datafield: 'penagihan_tgl', cellsformat: 'dd-MM-yyyy', cellsalign: 'center', width : 200},
                <?php if ($read <> '' || $update <> '') {?>
                { text: 'Edit', datafield: 'Edit', columntype: 'button', width:'50', align:'center', sortable:false, filterable: false,
                    cellsrenderer: function () {
                        ...
                        $("#grid").offset();
                        window.location.href='<?php echo BASE_URL ?>/controllers/C_penagihan.php?action=formtransaksi&id='+dataRecord.penagihan_id;
                    }
                },
                <?php } ?>
            ]
...
<script>
    function addtransaksi() {
        window.location.href='<?php echo BASE_URL ?>/controllers/C_penagihan.php?action=formtransaksi';
    }
</script>