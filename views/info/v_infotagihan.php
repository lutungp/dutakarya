    ...
    function renderGrid2(tanggal) {
        ...
        $("#jadwalkirimgrid").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                $("#rekananfilter2").jqxDropDownList({ selectedIndex: 0, autoOpen: true, source: rekananAdapter2, checkboxes: true, displayMember: "rekanan_nama", valueMember: "rekanan_id", width: 120, height: 28,});
                var barangSource2 = {
                    datatype: "json",
                    datafields: [
                        { name: 'barang_id' },
                ...
                $("#barangfilter2").jqxDropDownList({ selectedIndex: 0, autoOpen: true, source: barangAdapter, checkboxes: true, displayMember: "barang_nama", valueMember: "barang_id", width: 120, height: 28,});
