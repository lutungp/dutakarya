...
class C_supplier
{
    ...
    {
        $fieldSave = ["rekanan_nama", "rekanan_kode", "rekanan_jenis", "rekanan_telp", "rekanan_email", "rekanan_alamat", "rekanan_created_by",  "rekanan_created_date", "rekanan_revised"];
        $dataSave = [$data["rekanan_nama"], $data["rekanan_kode"], $data["rekanan_jenis"], $data["rekanan_telp"], $data["rekanan_email"], nl2br($data["rekanan_alamat"]), $_SESSION["USER_ID"], date("Y-m-d H:i:s"), 0];
    ...
    {
        $fieldSave = ["rekanan_nama",  "rekanan_kode", "rekanan_jenis", "rekanan_telp", "rekanan_email", "rekanan_alamat", "rekanan_created_by",  "rekanan_created_date", "rekanan_revised"];
        $dataSave = [$data["rekanan_nama"], $data["rekanan_kode"], $data["rekanan_jenis"], $data["rekanan_telp"], $data["rekanan_email"], nl2br($data["rekanan_alamat"]), $_SESSION["USER_ID"], date("Y-m-d H:i:s"), "rekanan_revised+1"];
        $field = "";
